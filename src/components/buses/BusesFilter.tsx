        ...
        <CardContent>
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            <TabsList className="w-full justify-start mb-4 overflow-x-auto flex-nowrap">
              ...
              <TabsTrigger value="expiration">Fechas de Vencimiento</TabsTrigger>
              <TabsTrigger value="status">Estado y Aprobación</TabsTrigger>
            </TabsList>
            ...
            <TabsContent value="expiration" className="mt-0">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div className="space-y-2">
                  <Label htmlFor="expirationMonths">Vencimientos próximos</Label>
                  <Select 
