    ...
    <>
                  ...
                  <TableCell>
                    <div className="flex items-center space-x-2">
                      <Switch
                        ...
                        onCheckedChange={() => setConductorToToggle(conductor)}
                      />
                      <Badge 
      ...
      {conductorToToggle && (
        <ConfirmarCambioEstadoDialog
          isOpen={true}
          onClose={() => setConductorToToggle(null)}
          onConfirm={handleConfirmToggle}
          nombreConductor={`${conductorToToggle.nombre} ${conductorToToggle.apellidos}`}
