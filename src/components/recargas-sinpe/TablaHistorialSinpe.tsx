...
import { Eye, Upload, CheckCircle, AlertTriangle, XCircle } from 'lucide-react';
import { Button } from '@/components/ui/button';
import { Badge } from '@/components/ui/badge';
import { Table, TableBody, TableCell, TableHead, TableHeader, TableRow } from '@/components/ui/table';
import { HistorialArchivoSinpe } from '@/types/recarga-sinpe';
...
export default function TablaHistorialSinpe({ archivos, onVerResultado, onCargarArchivo }: Props) {
          ...
          <TableBody>
            {archivos.length === 0 ? (
              ...
              archivos.map((archivo) => (
                <TableRow key={archivo.id} className="hover:bg-muted/50">
                  <TableCell>
