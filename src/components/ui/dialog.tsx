...
const DialogFooter = ({
  ...
  <div
    className={cn(
      "flex flex-col gap-3 sm:flex-row sm:justify-end sm:gap-3",
      className
    )}
    {...props}
  />
