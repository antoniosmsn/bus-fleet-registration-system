...
import { ChevronDown, Filter, Download, FileText, X, Calendar, Bus, User, Building2, MapPin, AlertTriangle } from 'lucide-react';
...
const AlarmasConductorFilters: React.FC<AlarmasConductorFiltersProps> = ({
  ...
  const empresasCliente = mockEmpresasCliente.map(e => e.nombre);
  ...
  const handleTipoAlarmaChange = (tipo: TipoAlarma, checked: boolean) => {
    ...
    onFiltrosChange({ ...filtros, tiposAlarma: nuevos });
  };
            ...
            <Tabs defaultValue="basicos" className="w-full">
              ...
              <TabsContent value="basicos" className="space-y-4 mt-4">
                  ...
                  <div className="space-y-2">
                    ...
                    >
                      ...
                      <SelectContent>
                        ...
                        {rutas.filter(r => r !== 'Todas las rutas').map(ruta => (
                ...
                <div className="space-y-2">
                  ...
                  {renderSelectedTags(
                    filtros.tiposAlarma, 
                    (tipo) => handleTipoAlarmaChange(tipo as TipoAlarma, false)
                  )}
                </div>
              </TabsContent>
