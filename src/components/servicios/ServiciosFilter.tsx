...
const ServiciosFilter: React.FC<ServiciosFiltrosProps> = ({ filtros, onFiltrosChange }) => {
  ...
  const empresasCliente = [
    ...
    { value: 'microsoft', label: 'Microsoft Costa Rica' },
    { value: 'amazon', label: 'Amazon Development Center' }
  ];

  const transportistas = [
    { value: '1', label: 'Transportes San José S.A. (TSJ001)' },
    { value: '2', label: 'Autobuses del Valle (ADV002)' },
    { value: '3', label: 'Empresa de Transporte Central (ETC003)' }
  ];

  const ramales = [
    { value: '1', label: 'San José - Cartago (pública)' },
    { value: '2', label: 'Heredia - Alajuela (pública)' },
    { value: '3', label: 'Zona Franca Intel (privada - Intel Corporation)' }
  ];
