...
const mockPasajeros: Pasajero[] = [
  ...
  {
    id: 4,
    empresaCliente: "Tech Solutions Inc",
    cedula: "301450789",
    nombres: "María José",
    primerApellido: "González",
    segundoApellido: "Ramírez",
    correoElectronico: "maria.gonzalez@techsolutions.com",
    telefono: "2222-3333",
    tipoPago: "prepago",
    empresaSubcontratista: "Rutas Express",
    tipoContrato: "directo",
    planilla: "mensual",
    limiteViajesSemana: 12,
    limiteDiario: 2,
    tipoSubsidio: "porcentual",
    subsidioPorcentual: 80,
    subsidioMonto: 0,
    numeroEmpleadoInterno: "1001",
    badgeInterno: "TECH001",
    tagResidencia: "Alajuela, Centro",
    saldoPrepago: 15000,
    saldoPostpago: 0,
    estado: "activo",
    solicitudRuta: true,
  ...
  {
    id: 5,
    empresaCliente: "Banco Nacional de Costa Rica",
    cedula: "105670234",
    nombres: "Carlos Alberto",
    primerApellido: "Vargas",
    segundoApellido: "Méndez",
    correoElectronico: "carlos.vargas@bncr.fi.cr",
    telefono: "4444-5555",
    tipoPago: "postpago",
    empresaSubcontratista: "Transportes del Valle",
    tipoContrato: "indirecto",
    planilla: "quincenal",
    limiteViajesSemana: 14,
    limiteDiario: "sin_limite",
    tipoSubsidio: "porcentual",
    subsidioPorcentual: 90,
    subsidioMonto: 0,
    numeroEmpleadoInterno: "2050",
    badgeInterno: "BNCR2050",
    tagResidencia: "Puntarenas, Centro",
    saldoPrepago: 0,
    saldoPostpago: 0,
    estado: "activo",
    solicitudRuta: false,
    fechaCreacion: "2024-02-01T14:30:00Z",
    usuarioCreacion: "admin@empresa.com",
    fechaModificacion: null,
    usuarioModificacion: null
  },
  {
    id: 6,
    empresaCliente: "Intel Costa Rica",
    cedula: "207890123",
    nombres: "Ana Carolina",
    primerApellido: "Jiménez",
    segundoApellido: "Castro",
    correoElectronico: "ana.jimenez@intel.com",
    telefono: "6666-7777",
    tipoPago: "prepago",
    empresaSubcontratista: "Mega Transportes",
    tipoContrato: "directo",
    planilla: "semanal",
    limiteViajesSemana: 10,
    limiteDiario: 2,
    ...
    subsidioPorcentual: 100,
    subsidioMonto: 0,
    numeroEmpleadoInterno: "3075",
    badgeInterno: "INTEL3075",
    tagResidencia: "Guanacaste, Liberia",
    saldoPrepago: 25000,
    saldoPostpago: 0,
    estado: "activo",
    solicitudRuta: true,
    fechaCreacion: "2024-02-10T09:45:00Z",
    usuarioCreacion: "admin@empresa.com",
    fechaModificacion: null,
    usuarioModificacion: null
  },
  {
    id: 7,
    empresaCliente: "Grupo Mutual",
    cedula: "309876543",
    nombres: "Luis Fernando",
    primerApellido: "Solano",
    segundoApellido: "Vega",
    correoElectronico: "luis.solano@mutual.cr",
    telefono: "8888-9999",
    tipoPago: "postpago",
    empresaSubcontratista: "Líneas Doradas",
    tipoContrato: "indirecto",
    planilla: "mensual",
    limiteViajesSemana: 12,
    limiteDiario: 2,
    tipoSubsidio: "por_monto",
    subsidioPorcentual: 0,
    subsidioMonto: 5000,
    numeroEmpleadoInterno: "4100",
    badgeInterno: "MUTUAL4100",
    tagResidencia: "Limón, Puerto Limón",
    saldoPrepago: 0,
    saldoPostpago: 0,
    estado: "inactivo",
    solicitudRuta: false,
    fechaCreacion: "2024-02-20T16:20:00Z",
    usuarioCreacion: "admin@empresa.com",
    fechaModificacion: "2024-03-01T10:00:00Z",
    usuarioModificacion: "supervisor@empresa.com"
  },
  {
    id: 8,
    empresaCliente: "Scotiabank Costa Rica",
    cedula: "401234567",
    nombres: "Patricia Elena",
    primerApellido: "Hernández",
    segundoApellido: "Morales",
    correoElectronico: "patricia.hernandez@scotiabank.com",
    telefono: "2222-4444",
    tipoPago: "prepago",
    empresaSubcontratista: "Autobuses Modernos",
    tipoContrato: "directo",
    planilla: "quincenal",
    limiteViajesSemana: 14,
    limiteDiario: "sin_limite",
    ...
    subsidioPorcentual: 75,
    subsidioMonto: 0,
    numeroEmpleadoInterno: "5200",
    badgeInterno: "SCOTIA5200",
    tagResidencia: "Pérez Zeledón, San Isidro",
    saldoPrepago: 18000,
    saldoPostpago: 0,
    estado: "activo",
    solicitudRuta: true,
    fechaCreacion: "2024-03-05T12:15:00Z",
    usuarioCreacion: "admin@empresa.com",
    fechaModificacion: null,
    usuarioModificacion: null
  },
  {
    ...
    correoElectronico: "roberto.chaves@microsoft.com",
    telefono: "5555-6666",
    tipoPago: "postpago",
    empresaSubcontratista: "Transportes Rápidos",
    tipoContrato: "directo",
    planilla: "semanal",
    limiteViajesSemana: 10,
    limiteDiario: 2,
    ...
    subsidioPorcentual: 100,
    subsidioMonto: 0,
    numeroEmpleadoInterno: "6300",
    badgeInterno: "MSFT6300",
    tagResidencia: "Cartago, Turrialba",
    saldoPrepago: 0,
    saldoPostpago: 0,
    estado: "cambio_password",
    solicitudRuta: false,
    fechaCreacion: "2024-03-12T08:00:00Z",
    usuarioCreacion: "admin@empresa.com",
    fechaModificacion: "2024-03-15T14:45:00Z",
    usuarioModificacion: "it@empresa.com"
  },
  {
    id: 10,
    empresaCliente: "Hewlett Packard Enterprise",
    cedula: "603456789",
    nombres: "Carmen María",
    primerApellido: "Quirós",
    segundoApellido: "Vindas",
    correoElectronico: "carmen.quiros@hpe.com",
    telefono: "7777-8888",
    tipoPago: "prepago",
    empresaSubcontratista: "Buses del Futuro",
    tipoContrato: "indirecto",
    planilla: "mensual",
    limiteViajesSemana: 12,
    limiteDiario: 2,
    ...
    subsidioPorcentual: 0,
    subsidioMonto: 7500,
    numeroEmpleadoInterno: "7400",
    badgeInterno: "HPE7400",
    tagResidencia: "San José, Escazú",
    saldoPrepago: 22000,
    saldoPostpago: 0,
    estado: "activo",
    solicitudRuta: true,
    fechaCreacion: "2024-03-18T13:30:00Z",
    usuarioCreacion: "admin@empresa.com",
    fechaModificacion: null,
    usuarioModificacion: null
  },
  {
    ...
    correoElectronico: "diego.campos@amazon.com",
    telefono: "3333-4444",
    tipoPago: "postpago",
    empresaSubcontratista: "Transportes Premium",
    tipoContrato: "directo",
    planilla: "quincenal",
    limiteViajesSemana: 14,
    limiteDiario: "sin_limite",
    tipoSubsidio: "porcentual",
    subsidioPorcentual: 95,
    subsidioMonto: 0,
    numeroEmpleadoInterno: "8500",
    badgeInterno: "AMZN8500",
    tagResidencia: "Heredia, Belén",
    saldoPrepago: 0,
    saldoPostpago: 0,
    estado: "solicitud_traslado",
    solicitudRuta: false,
    fechaCreacion: "2024-03-22T10:15:00Z",
    usuarioCreacion: "admin@empresa.com",
    fechaModificacion: "2024-03-25T09:30:00Z",
    usuarioModificacion: "hr@empresa.com"
  },
  {
    id: 12,
    empresaCliente: "Procter & Gamble",
    cedula: "805678901",
    nombres: "Gabriela Andrea",
    primerApellido: "Montero",
    segundoApellido: "Alfaro",
    correoElectronico: "gabriela.montero@pg.com",
    telefono: "9999-1111",
    tipoPago: "prepago",
    empresaSubcontratista: "Autobuses Elite",
    tipoContrato: "indirecto",
    planilla: "semanal",
    limiteViajesSemana: 10,
    limiteDiario: 2,
    tipoSubsidio: "porcentual",
    subsidioPorcentual: 85,
    subsidioMonto: 0,
    numeroEmpleadoInterno: "9600",
    badgeInterno: "PG9600",
    tagResidencia: "Alajuela, Atenas",
    saldoPrepago: 12000,
    saldoPostpago: 0,
    estado: "traslado_rechazado",
    solicitudRuta: true,
    fechaCreacion: "2024-03-28T15:45:00Z",
    usuarioCreacion: "admin@empresa.com",
    fechaModificacion: "2024-04-02T11:20:00Z",
    usuarioModificacion: "manager@empresa.com"
  }
];
...
const PasajerosIndex = () => {
  ...
  const itemsPerPage = 5; // Changed from 8 back to 5
